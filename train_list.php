...
<!-- container 2nd -->
<div class="container-fluid bg-light border-left border-right mt-5">
    <!-- heading of booking card -->
       <div class="row border bg-white ml-1 mr-1 mb-2 text-bold p-1">
           ...
           <div class="sm-hide col-sm-2 offset-1 text-center">
               Book
           </div>
       </div>
       <!-- list of trains -->
                ...
                <form action="./psg_details.php" method="post" class="row">
                    ...
                    <div class="col-12 col-md-7 hvr-shadow">
                        <div class="card-body row">
                           ...
                           <div class="col-2">
                            <img src="asset/img/logo/price.png" width="30"><br><br>
                            <span class="font-light">&nbsp;&nbsp;<?php echo $data["fare"];
                            ?></span>
