...
<body class="bg-light">
    ...
    <div class="container-fluid border border-primary mt-5 mb-5 p-4">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 ">
                        <div class="card bg-light">
                            <div class="card-body">
                                <form action="ticket_details.php" name="payForm" onsubmit="return(payvalid());"  method="post" class="">
...
<script type="text/javascript">
    ...
    function payvalid(){
            ...
            window.location="ticket_details.php";
            return true;
